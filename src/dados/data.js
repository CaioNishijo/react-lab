export const sculptureList = [
    {
      ...
      description: `Although Colvin is predominantly known for abstract themes that allude 
        to pre-Hispanic symbols, this gigantic sculpture, an homage to neurosurgery, is one of 
        her most recognizable public art pieces.`,
    ...
    },
    {
      ...
      description: `This enormous (75 ft. or 23m) silver flower is located in Buenos 
        Aires. It is designed to move, closing its petals in the evening or when strong winds 
        blow and opening them in the morning.`,
      url: 'https://i.imgur.com/ZF6s192m.jpg',
      alt: `A gigantic metallic flower sculpture with reflective mirror-like petals and 
        strong stamens.`
    },
    {
      name: 'Eternal Presence',
      artist: 'John Woodrow Wilson',
      description: `Wilson was known for his preoccupation with equality, social justice, 
        as well as the essential and spiritual qualities of humankind. This massive (7ft. or 
        2,13m) bronze represents what he described as "a symbolic Black presence infused with 
    ...
    },
    {
      ...
      description: `Located on the Easter Island, there are 1,000 moai, or extant 
        monumental statues, created by the early Rapa Nui people, which some believe 
        represented deified ancestors.`,
    ...
    },
    {
      ...
      description: `Descended from four generations of woodcarvers, Fakeye's work blended 
        traditional and contemporary Yoruba themes.`,
    ...
    },
    {
      name: 'Hippos',
      artist: 'Taipei Zoo',
      description: `The Taipei Zoo commissioned a Hippo Square featuring submerged hippos 
        at play.`,
